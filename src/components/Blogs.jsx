  ...
  return (
    <div className="p-4   dark:bg-gray-900 dark:text-blue-200 w-full h-screen mt-10 xl:mt-20 font-sans ">
      <div className="flex justify-center">
        <h2 className="w-full font-playfair px-border-cyan-700 4 justify-start flex font-bold text-3xl md:text-4xl text-blue-400 dark:text-cyan-600 border-b-2 border-blue-400 dark:border-cyan-600">
          Blogs
        </h2>
      </div>
      <div className="flex ">
